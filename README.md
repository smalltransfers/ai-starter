This is a [Small Transfers](https://smalltransfers.com) AI starter project. (See also the [Small Transfers Next.js Starter](https://github.com/smalltransfers/nextjs-starter).)
